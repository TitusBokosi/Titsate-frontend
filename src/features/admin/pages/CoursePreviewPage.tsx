...
export function CoursePreviewPage() {
    ...
    return (
      <div className="flex h-[80vh] flex-col items-center justify-center gap-4">
        ...
        <p className="text-muted-foreground mb-4">
          The course you are looking for might have been deleted or the link is
          invalid.
        </p>
        <Button onClick={() => navigate('/creator/approvals')}>
          Back to Approvals
        </Button>
      </div>
    );
  ...
  return (
    <div className="flex flex-col h-full space-y-6 animate-in fade-in duration-700">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              <Badge
                variant="outline"
                className="bg-primary/5 text-primary border-primary/20 text-[10px] uppercase tracking-wider font-bold"
              >
      ...
      {/* Main Content Layout */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 flex-1 min-h-150 items-start">
            ...
            {(course.topics?.length === 0 || !course.topics) && (
              <div className="text-center py-16 border border-dashed rounded-xl bg-muted/5">
                ...
                <p className="text-muted-foreground italic text-sm px-4">
                  This course doesn't have any topics or lessons yet.
                </p>
              </div>
            )}
          </div>
        ...
        {/* Main: Lesson Preview */}
        <div className="lg:col-span-8 bg-card/30 rounded-2xl border border-white/5 p-8 min-h-125 shadow-sm">
          {selectedLesson ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-center space-y-4 py-20">
              ...
              <div>
                ...
                <p className="text-muted-foreground max-w-sm mx-auto">
                  Select a lesson from the curriculum list on the left to review
                  its content and media.
                </p>
              </div>
            </div>
          )}
